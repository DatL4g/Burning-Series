...
data object TestVideo {
    ...
    fun filter(list: Collection<DirectLink>): ImmutableSet<DirectLink> {
        return list.filterNot { link ->
            testVideos.any { it.equals(link) }
        }.filterNot { link ->
            val url = parseUrl(link.url) ?: return@filterNot false

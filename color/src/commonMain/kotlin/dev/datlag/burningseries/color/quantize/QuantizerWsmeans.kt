...
object QuantizerWsmeans {
    ...
    fun quantize(
        ...
        val distanceToIndexMatrix: Array<Array<Distance?>> = Array(clusterCount) {
            Array(clusterCount) { Distance() }
        }
    ...
    private class Distance internal constructor() : Comparable<Distance?> {
        ...
        override operator fun compareTo(other: Distance?): Int {
            return if (other != null) distance.compareTo(other.distance) else 0
        }
    }
}
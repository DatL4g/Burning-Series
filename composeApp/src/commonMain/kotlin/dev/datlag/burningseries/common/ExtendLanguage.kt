...
import dev.datlag.burningseries.composeapp.generated.resources.english_subtitle
...
val Language?.title: StringResource
    get() = when (this) {
        ...
        is Language.JapaneseSubtitle -> Res.string.english_subtitle
    }
...
val Home.Episode.Flag.languageByCode: StringResource?
    get() = when {
        ...
        this.bestCountryCode.equals(Language.JapaneseSubtitle.code, ignoreCase = true) -> Res.string.english_subtitle
        else -> null
    }
